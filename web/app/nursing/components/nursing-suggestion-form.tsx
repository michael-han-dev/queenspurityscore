...
export function NursingSuggestionForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await saveFacultySuggestion(suggestion, 'nursing');
  ...
  return (
    <div className="p-4 border border-[#d4c9a8] rounded-md bg-[#f8f3e6]">
      <h3 className="text-lg font-medium mb-2 text-center">Suggest a Nursing Prompt</h3>
      <form onSubmit={handleSubmit} className="space-y-2">
        <input
          type="text"
          value={suggestion}
          onChange={(e) => setSuggestion(e.target.value)}
          placeholder="Enter your nursing prompt suggestion..."
